...
<div class="container max-w-[1600px] md:p-20 p-4">
	<Text type="title-3" weight="semibold" class="block text-center">Data Protection Notice</Text>
	<div class="mt-4">
		<Text type="body-1">
			This Data Protection Notice (“Notice”) sets out the basis which Luxehouze SG Pte. Ltd. (“we”,
			“us”, or “our”) may collect, use, disclose or otherwise process personal data of our customers
			in accordance with the Personal Data Protection Act (“PDPA”). This Notice applies to personal
	...
	<div class="mt-4">
		<Text type="body-1" weight="semibold">PERSONAL DATA</Text>
		<ul class="list-disc list-outside ml-4 p-4">
			<li>As used in this notice:</li>
			<ul class="list-disc list-outside ml-4 p-4">
				<li>
					“customer” means an individual who (a) has contacted us through any means to find out more
					about any goods or services we provide, or (b) may, or has, entered into a contract with
			...
			<li>
				...
				may collect from you include your name and identification information such as your NRIC
	...
	<div class="mt-4">
		<Text type="body-1" weight="semibold">COLLECTION, USE AND DISCLOSURE OF PERSONAL DATA</Text>
		<ul class="list-disc list-outside ml-4 p-4">
			<li>
				...
				representative) have been notified of the purposes for which the data is collected, and (ii)
				you (or your authorised representative) have provided written consent to the collection and
				usage of your personal data for those purposes, or (b) collection and use of personal data
				without consent is permitted or required by the PDPA or other laws. We shall seek your
				consent before collecting any additional personal data and before using your personal data
				for a purpose which has not been notified to you (except where permitted or authorised by
				law).
			</li>
			...
			<ul class="list-disc list-outside ml-4 p-4">
				...
				<li>
					responding to, handling, and processing queries, requests, applications, complaints, and
					feedback from you;
				</li>
				<li>managing your relationship with us;</li>
				<li>processing payment or credit transactions</li>
				<li>
					sending your marketing information about our goods or services including notifying you of
					our marketing events, initiatives and promotions, lucky draws, membership and rewards
					schemes and other promotions;
				</li>
				<li>
					complying with any applicable laws, regulations, codes of practice, guidelines, or rules,
					or to assist in law enforcement and investigations conducted by any governmental and/or
					regulatory authority;
				</li>
				<li>any other purposes for which you have provided the information;</li>
				<li>
					transmitting to any unaffiliated third parties including our third party service providers
					and agents, and relevant governmental and/or regulatory authorities, whether in Singapore
			...
			<li>We may disclose your personal data:</li>
			<ul class="list-disc list-outside ml-4 p-4">
				<li>
	...
	<div class="mt-4">
		<Text type="body-1" weight="semibold">WITHDRAWING YOUR CONSENT</Text>
		<ul class="list-disc list-outside ml-4 p-4">
			<li>
				The consent that you provide for the collection, use and disclosure of your personal data
				will remain valid until such time it is being withdrawn by you in writing. You may withdraw
				consent and request us to stop using and/or disclosing your personal data for any or all of
			...
			<li>
				...
				nature and scope of your request, we may not be in a position to continue providing our
				goods or services to you and we shall, in such circumstances, notify you before completing
			...
			<li>
				...
				and disclose personal data where such collection, use and disclose without consent is
				permitted or required under applicable laws.
			</li>
		</ul>
	</div>
	<div class="mt-4">
		<Text type="body-1" weight="semibold">ACCESS TO AND CORRECTION OF PERSONAL DATA</Text>
		<ul class="list-disc list-outside ml-4 p-4">
			<li>
				...
				or (b) a correction request to correct or update any of your personal data which we hold
				about you, you may submit your request in writing or via email to our Data Protection
			...
			<li>
				...
				you in writing within thirty (30) days of the time by which we will be able to respond to
				your request. If we are unable to provide you with any personal data or to make a correction
	...
	<div class="mt-4">
		<Text type="body-1" weight="semibold">PROTECTION OF PERSONAL DATA</Text>
		<ul class="list-disc list-outside ml-4 p-4">
			<li>
				...
				encryption and the use of privacy filters to secure all storage and transmission of personal
				data by us, and disclosing personal data both internally and to our authorised third party
	...
	<div class="mt-4">
		<Text type="body-1" weight="semibold">ACCURACY OF PERSONAL DATA</Text>
		<ul class="list-disc list-outside ml-4 p-4">
			<li>
				...
				if there are changes to your personal data by informing our Data Protection Officer in
				writing or via email at the contact details provided below.
			</li>
		</ul>
	</div>
	<div class="mt-4">
		<Text type="body-1" weight="semibold">RETENTION OF PERSONAL DATA</Text>
		<ul class="list-disc list-outside ml-4 p-4">
			<li>
			...
			<li>
				...
				serves the purpose for which the personal data was collected, and is no longer necessary for
				legal or business purposes.
			</li>
		</ul>
	</div>
	<div class="mt-4">
		<Text type="body-1" weight="semibold">TRANSFERS OF PERSONAL DATA OUTSIDE OF SINGAPORE</Text>
		<ul class="list-disc list-outside ml-4 p-4">
			<li>
				We generally do not transfer your personal data to countries outside of Singapore. However,
				if we do so, we will obtain your consent for the transfer to be made and we will take steps
				to ensure that your personal data continues to receive a standard of protection that is at
				least comparable to that provided under the PDPA.
			</li>
		</ul>
	</div>
	<div class="mt-4">
		<Text type="body-1" weight="semibold">DATA PROTECTION OFFICER</Text>
		<ul class="list-disc list-outside ml-4 p-4">
			<li>
		...
		<Text type="body-1">
			Luxehouze Data Protection Officer <br />
			Luxehouze SG Pte. Ltd. <br />
			390 orchard Road, 02-03<br />
			Palais Renaissance <br />
			Singapore 238871
		</Text>
	</div>
	<div class="mt-4">
		<Text type="body-1" weight="semibold">EFFECT OF NOTICE AND CHANGES TO NOTICE</Text>
		<ul class="list-disc list-outside ml-4 p-4">
			<li>
				This Notice applies in conjunction with any other notices, contractual clauses and consent
				clauses that apply in relation to the collection, use and disclosure of your personal data
				by us.
			</li>
			<li>
				We may revise this Notice from time to time without any prior notice. You may determine if
				any such revision has taken place by referring to the date on which this Notice was last
				updated. Your continued use of our services constitutes your acknowledgement and acceptance
				of such changes.
			</li>
		</ul>
		<Text type="body-1">
			Effective date: 01 March 2022 <br />
