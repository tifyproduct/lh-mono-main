<script lang="ts">
	...
	import { Input, Helper, Spinner, Label } from 'flowbite-svelte';
	...
	export let showUpdatePasswordModal: boolean = false;
...
<Modal
	...
	title=" "
	onClose={() => (showUpdatePasswordModal = false)}
	padding="p-4 lg:p-7"
	fullScreenMobile
>
	...
	<div class="text-center mt-8 grid">
		<Text type="subtitle-2" color="black-9" weight="semibold">Update your Password</Text>
		<Text type="body-1" color="black-9"
			>Please create a new password. Choose one that's strong and unique to protect your account.</Text
		>
	</div>
